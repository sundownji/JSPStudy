...
<body>
	...
	<!-- 저장된 순서대로 Person 객체를 변수 list에 저장 후 
	...
	<%
	/*Java 코드를 사용하면 출력할 객체를 명시하고, getter를 직접 호출해야한다.
		(Person타입의 p에 하나씩 꺼냄)*/
	for(Person p : lists) {
	...
	<h4>Map 컬렉션 사용하기</h4>
	<%
	/*Map 계열의 컬렉션을 생성한다. Key는 String, Value는 Person 타입으로 지정한다. */
	...
	for(String key : keys){
		...
		멤버변수에 저장된 값을 getter를 통해 출력할 수 있다.*/
