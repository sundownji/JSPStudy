...
<!-- uri -> tomcat 10.1 버전은 위에처럼 쓰고 9버전은 java.sun.com/jsp/jstl/core  -->
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<body>
	...
	<!-- JSTL은 JSP코드이므로 value 속성에 기술할 때 객체를 생성하기 위한 더블쿼테이션이 겹쳐지는 경우가 발생하게된다.
		이때는 value를 싱글쿼테이션으로 감싸서 겹쳐지지 않게 처리해야한다.  -->
	...
	<!-- 리퀘스트 영역에 있는 비어있는 객체를 먼저 생성하고 밑에서 target,property를 통해
