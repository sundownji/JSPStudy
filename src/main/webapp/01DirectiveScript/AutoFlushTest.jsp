...
<!--
	...
	autoFlush속성을 통해 버퍼가 꽉 찬 경우 내보내기 할지를 설정할 수 있다.
...
/*  
	...
	여기에 HTML태그들이 포함되어 있으므로 해당 페이지의 용량은 1kb를 초과하게되어
	실행시 에러가 발생한다.
...
for (int i = 1; i<100; i++){
	...
	단, JSP가 웹브라우저에 내용을 출력할 때 버퍼를 사용하는 것을 인지하고,
	이를 통해 에러페이지 처리나 포워드 등의 기능을 수행할 수 있게된다.*/
}
%>
</body>
</html>