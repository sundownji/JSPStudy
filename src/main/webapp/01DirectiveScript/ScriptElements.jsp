...
<%!
//선언부는 !로 시작한다. 2개의 정수의 합을 반환하는 메서드 정의
public int add(int num1, int num2){
	return num1 + num2;
}
/* 
Java에서는 메서드내에 또 다른 메서드를 선언할 수 없다. 
JSP는 자바 문법을 따르므로 선언부에서 !를 제거하면 즉시 오류가 발생한다
!를 제거한다는 것은 _jspService() 내에 새로운 메서드를 선언하는 꼴이 되기 때문이다.*/
 %>
<!-- <!DOCTYPE html> -->
<html>
<head>
