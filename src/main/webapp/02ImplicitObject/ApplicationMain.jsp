...
<body>
	...
	<!--이클립스에서는 우리가 직접 작성한 파일을 실행하지 않고 .metadata 디렉토리
		하위에 프로젝트와 동일한 톰켓 환경을 만들어서 복사본 파일을 실행하게된다.
		따라서 아래의 물리적 경로는 .metadata 하위의 경로로 출력된다.-->
	...
	다른 지역인 선언부에서 사용하려면 매개변수로 전달받아야 한다.*/
	...
	public String useImplicitObject(ServletContext app){
		/* 방법2: 스크립트렛에서 메서드를 호출할 때 application 내장객체를
			매개변수로 전달해서 사용한다. */
