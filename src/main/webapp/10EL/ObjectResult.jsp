...
<body>
	...
	//따라서 영역에서 객체를 꺼낸 후 사용시에는 원래의 타입으로 형변환 해줘야 함
	Person person = (Person) object;
	//출력시에는 멤버변수에 직접 접근할 수 없기 때문에 getter()를 사용한다.
	...
	<!--
	파라미터 전달된 값을 읽을 때 아래 3가지 방법을 사용할 수 있다.
		param.파라미터명
		param['파라미터명']
		param["파라미터명"]
	-->
	<h2>매개변수로 전돨된 값 읽기</h2>
	<ul>
