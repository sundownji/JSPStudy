...
<body>
    ...
    <!--
    	...
    	=num1은 아무 값도 출력되지 않는다. 
    -->
    스크립틀릿에서 선언한 변수 : ${ num1 }  <br />    
    page 영역에 저장된 변수 : ${ num2 } <br />
    변수 할당 및 즉시 출력 : ${ num1 = 7 } <br />
    <!-- 
    	Tomcat8부터는 EL에서 변수할당을 할 수 있다.
    	하지만 변수할당과 동시에 출력되므로, 
    	할당문 뒤에 ;''을 붙여줘야 출력되지 않는다.
    ...
    <h3>산술 연산자</h3>
    <!-- EL식 안에서 연산자 사용하면 잘 나옴  -->
    num1 + num2 : ${ num1 + num2 } <br />
    num1 - num2 : ${ num1 - num2 } <br />
    num1 * num2 : ${ num1 * num2 } <br />
    <!-- 
    	나눗셈에는 /와 div연산자를 사용할 수 있다. 
    	또한 자동형변환이 적용되므로 정수끼리의 연산에서 실수의 결과가 나올 수 있다.
    -->
    ...
    <h3>+ 연산자는 덧셈만 가능</h3>  
    num1 + "34" : ${ num1 + "34" } <br />
    <!-- 숫자와 문자열, 혹은 문자열과 문자열을 더 하는 경우는
    	 연산이 불가능하므로 예외가 발생한다. 주석처리해놨음  -->
    num2 + "이십" : \${num2 + "이십" }  <br /> 
    "삼십" + "사십" : \${"삼십" + "사십" } 
    ...
    <!--  항상 왼쪽을 기준
		...
		== : eq(EQual)
		!= : ne(Not Equal)
		EL에서는 Java에서 사용하던 기본적인 비교연산자와 
		문자형태의 연산자 두가지 모두 사용할 수 있다.
    -->
