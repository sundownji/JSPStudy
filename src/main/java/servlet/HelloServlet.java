...
4.request내장객체를 사용할 때는 매개변수 req를 이용한다.
...
public class HelloServlet extends HttpServlet{
	...
	//서블릿에서 get방식으로 받는 방법 : doGet 자동완성
	//HttpServletRequeset-request의 원래 타입 req는 매개변수
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		/* 리퀘스트 영역은 포워드 된 페이지까지 공유되므로 서블릿에서 저장한 속성은 JSP에서 사용할 수 있다.*/
	}
	
	//post방식으로 받아서 처리하는 방법
	@Override
